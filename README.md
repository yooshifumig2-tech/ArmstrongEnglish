...
- 按游戏资源与制作难度划分 5 个制作阶级：Survival、Explorer、Engineer、Treasure 与 Legend
- 每一阶都有 3 件解锁任务物品；先按原版配方完成制作，再进入该物品的英语考核
- 考核包含拖动词块造句、时态/单复数判断与物品英文拼写；答错会显示语法解析，订正后才能继续
- 完成当前任务清单的全部制作与考核后自动解锁下一阶，并开放该阶的配方
- XP、已完成配方、考核状态、制作阶级与累计合成次数保存在当前浏览器
- 桌面端与移动端响应式布局
